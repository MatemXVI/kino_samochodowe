...
//generujemy kod!!! i zapisujemy do pliku
	...
	if(isset($_SESSION['uzytkownik']) && isset($_POST['numer_miejsca_parkingowego'])){
		...
		$query="UPDATE `bilet` SET `IDUzytkownika` = $id_uzytkownika, data_wygenerowania = '$data' WHERE NumerMiejscaParkingowego = '$miejsce_parkingowe' AND IDSeansu = '$wybrany_seans'" ;
		if($result = $mysqli->query($query)){
			...
			$_SESSION['komunikat'] = "<span style='color:green'>Bilet został zakupiony. Pamiętaj, że tylko z nim możesz wejść na seans.<br> Zeskanuj kod QR przy wjeździe na parking.<br>Życzymy miłego oglądania<br></span>";
