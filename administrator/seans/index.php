		...
		<section>
			<h2>Seanse:</h2>
				...
				<table align="center" class="lista">
					<tr><th>ID Seansu</th><th>Nazwa</th><th>Data</th><th>Godzina</th><th>Cena biletu</th><th colspan="2">Akcja</th></tr>
					<?php
					while($row = mysqli_fetch_assoc($result)){ ?>
						<tr>
							...
							<td><a href="usun_seans.php?id_seansu=<?php echo $row['IDSeansu'] ?>" title="Seans dodał administrator nr: <?php echo $row['IDAdministratora'] ?>"><b>USUŃ</b></a></td>
							<td><a href="edytuj_seans.php?id_seansu=<?php echo $row['IDSeansu'] ?>" title="Seans dodał administrator nr: <?php echo $row['IDAdministratora'] ?>"><b>EDYTUJ</b></a></td>
						</tr>						
				<?php } ?>							
				</table><p>
				<?php
				...
				?>
				<p class="dodaj"><a href='dodaj_seans.php'><b>DODAJ NOWY SEANS </b></a></p>
			<br>
				<?php
				}else{
						echo "<h2>Brak seansów</h2>
								<div><a href='dodaj_seans.php'><b>DODAJ SEANS </b></a></div>";
					}
