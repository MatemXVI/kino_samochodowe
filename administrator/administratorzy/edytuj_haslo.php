		...
		<section>			
			...
			<div class="formularz">
				<form action='edycja_hasla.php' method='post'>
					<div class="pole_formularza_maly_odstep"><label>Nowe hasło:<br><input type="text" id="haslo" name="haslo"></label></div>
					<div class="pole_formularza_maly_odstep"><label>Powtórz hasło:<br><input type="text" id="powt_haslo" name="powt_haslo"></label></div>
